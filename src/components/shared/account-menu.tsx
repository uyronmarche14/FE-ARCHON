      ...
      <DropdownMenuTrigger asChild>
        {isSidebar ? (
          <button
            type="button"
            className={cn(
              "flex w-full items-center gap-3 rounded-md border border-transparent px-2 py-2 text-left transition-colors hover:bg-accent focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
          ...
          <Button
            variant="outline"
            size="icon-sm"
            className="rounded-xl bg-card/85 shadow-none"
            aria-label="Open account menu"
          >
